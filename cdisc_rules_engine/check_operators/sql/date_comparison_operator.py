...
class DateComparisonOperator(BaseSqlOperator):
    ...
    def execute_operator(self, other_value):
        ...
        if isinstance(target, str) and self.sql_data_service.pgi.schema.column_exists(self.table_id, target.lower()):
            target = target.lower()
        ...
        if (
            ...
            and self.sql_data_service.pgi.schema.column_exists(self.table_id, comparator.lower())
        ):
