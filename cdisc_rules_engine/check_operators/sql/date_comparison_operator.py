...
class DateComparisonOperator(BaseSqlOperator):
    ...
    def _build_truncated_comparison_elements(self, wrapped_target: str, wrapped_comparator: str) -> Tuple[str, str]:
        """
    ...
    def execute_operator(self, other_value):
        ...
        if date_component:
            ...
            _, trunc_length, start_pos = component_map.get(date_component, ("EPOCH", 0, 0))
