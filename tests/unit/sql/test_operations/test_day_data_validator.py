...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            [
                {"params": {"$usubjid": 1, "$id": 1}, "value": [4]},
                {"params": {"$usubjid": 2, "$id": 2}, "value": [32]},
                {"params": {"$usubjid": 3, "$id": 3}, "value": [1]},
                {"params": {"$usubjid": 4, "$id": 4}, "value": [13]},
                {"params": {"$usubjid": 5, "$id": 5}, "value": [None]},
                {"params": {"$usubjid": 6, "$id": 6}, "value": [None]},
                {"params": {"$usubjid": 7, "$id": 7}, "value": [-1]},
            ],
        ),
        (
            {
            ...
            [
                {"params": {"$usubjid": 1, "$id": 1}, "value": [1]},
                {"params": {"$usubjid": 2, "$id": 2}, "value": [2]},
                {"params": {"$usubjid": 3, "$id": 3}, "value": [-1]},
            ],
        ),
    ],
    ...
    [
        (
            ...
            [
                {"params": {"$usubjid": 1, "$id": 1}, "value": [4]},
                {"params": {"$usubjid": 2, "$id": 2}, "value": [32]},
                {"params": {"$usubjid": 999, "$id": 3}, "value": [None]},
            ],
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            [
                {"params": {"$usubjid": 1, "$id": 1}, "value": [None]},
                {"params": {"$usubjid": 2, "$id": 2}, "value": [None]},
                {"params": {"$usubjid": 3, "$id": 3}, "value": [None]},
                {"params": {"$usubjid": 4, "$id": 4}, "value": [1]},
            ],
        ),
    ],
)
