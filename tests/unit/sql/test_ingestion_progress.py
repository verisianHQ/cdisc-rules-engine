...
from cdisc_rules_engine.enums.progress_parameter_options import ProgressParameterOptions  # noqa
from cdisc_rules_engine.utilities.ingestion_progress import (  # noqa
...
def test_click_progress_bar_moves_with_known_row_totals():
    ...
    # The filled block character should appear at least once.
    assert "\u2588" in rendered
...
def test_click_progress_bar_extends_when_total_unknown():
    ...
    # Report more rows than the byte-based estimate so the bar must extend.
