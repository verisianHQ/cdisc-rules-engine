...
def test_read_metadata():
    ...
    """
    test_dataset_path: str = f"{os.path.dirname(__file__)}/../resources/test_dataset.ndjson"
    ...
    assert metadata["dataset_modification_date"] == "2024-11-11T15:09:16", "Test file has been changed"
