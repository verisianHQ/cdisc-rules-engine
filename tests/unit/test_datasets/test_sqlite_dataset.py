...
def test_merge_left(db_config):
    ...
    # currently returning merged.data as [{'col1': 1, 'col2': 'A'},
    # {'col1': 2, 'col2': 'B', 'col3': 85}, {'col1': 3, 'col2': 'C', 'col3': 90}]
...
def test_groupby_single_column(db_config):
    data = {"col1": ["A", "B", "A", "B", "A"], "col2": [10, 20, 15, 25, 30]}
    dataset = SQLiteDataset.from_dict(data, db_config)
...
def test_iloc_row_slice(db_config):
    ...
    # {'col1': 3, 'col2': 'C'}, {'col1': 4, 'col2': 'D'}, {'col1': 5, 'col2': 'E'}]
