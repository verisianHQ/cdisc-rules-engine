...
## Missing Operators (8 operators, 92 total failures across 28 rule occurrences)
...
## Execution Errors by Type (18 unique error types, 226 total failures across 61 rule occurrences)
