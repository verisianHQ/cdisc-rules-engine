...
1.  **inconsistent_enumerated_columns**: 2 failures across 1 rules
...
## Execution Errors by Type (14 unique error types, 141 total failures across 31 rule occurrences)
