...
## Missing Operations (10 operations, 61 total failures across 14 rule occurrences)
...
## Execution Errors by Type (14 unique error types, 166 total failures across 39 rule occurrences)

1.  **An unknown exception has occurred**: 81 failures across 18 rules
2.  **SQL error in matches_regex operator**: 22 failures across 3 rules
3.  **SQL error in not_equal_to operator**: 14 failures across 3 rules
...
7.  **SQL error in not_matches_regex operator**: 3 failures across 2 rules
