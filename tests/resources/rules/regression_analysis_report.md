...
- **Rules with any errors**: 60 (7.9%)
- **Clean rules**: 702 (92.1%)

**Error Breakdown by Category:**

- Rules with **operator errors**: 27
- Rules with **operation errors**: 17
- Rules with **other errors**: 16

## Missing Operators (8 operators, 90 total failures across 27 rule occurrences)
...
4.  **starts_with**: 3 failures across 1 rules
5.  **ends_with**: 2 failures across 1 rules
6.  **has_next_corresponding_record**: 2 failures across 1 rules
7.  **empty_within_except_last_row**: 2 failures across 1 rules
8.  **prefix_equal_to**: 2 failures across 1 rules
...
## Execution Errors by Type (18 unique error types, 224 total failures across 60 rule occurrences)
...
9.  **SQL error in starts_with operator**: 3 failures across 1 rules
10. **SQL error in ends_with operator**: 2 failures across 1 rules
...
13. **SQL error in prefix_not_equal_to operator**: 2 failures across 1 rules
...
### SQL Errors where Old Engine Skipped (74 cases)
...
### SQL Success where Old Engine Skipped (364 cases)
