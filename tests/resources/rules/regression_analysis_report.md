...
- **Rules with any errors**: 57 (7.5%)
- **Clean rules**: 705 (92.5%)
...
## Missing Operators (4 operators, 82 total failures across 23 rule occurrences)
...
## Execution Errors by Type (15 unique error types, 219 total failures across 57 rule occurrences)
...
12. **SQL error in date_equal_to operator**: 1 failures across 1 rules
13. **SQL error in is_not_unique_set operator**: 1 failures across 1 rules
14. **SQL error in date_less_than operator**: 1 failures across 1 rules
15. **SQL error in sqldistinctoperation operation**: 1 failures across 1 rules
