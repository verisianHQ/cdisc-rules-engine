...
## Missing Operations (9 operations, 73 total failures across 12 rule occurrences)
...
## Execution Errors by Type (15 unique error types, 139 total failures across 31 rule occurrences)

1.  **An unknown exception has occurred**: 76 failures across 14 rules
